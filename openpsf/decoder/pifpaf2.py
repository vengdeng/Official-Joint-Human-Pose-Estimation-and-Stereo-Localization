...
from .utils import scalar_square_add_single, normalize_pif, normalize_paf,normalize_psf
...
class PifPaf():
    ...
    def __call__(self, fields):
        ...
        psf = fields[2]
        connects = normalize_psf(*psf[0][0])
        ...
        for tt in range(2):
            ...
            gen = PifPafGenerator(
                pif, paf,targets_sf=targets_psf,
                stride=self.stride,
    ...
    def score_psf_target(self,pafsss, pifhr_floor=0.01, score_th=0.05,gens = []):
        scored_connection = []
        for c, fourds in enumerate(pafsss):
            ...
            if pifhr_floor < 1.0:
               pifhr_b = scalar_values(gens[0]._pifhr[j1i],
...
class PifPafGenerator(object):
    def __init__(self, pifs_field, pafs_field, *,targets_sf,
                 stride,
                 seed_threshold,
                 connection_method,
                 pif_nn,
        ...
        self._pifhr = 0.8 * self._pifhr + 0.2 * targets_sf
